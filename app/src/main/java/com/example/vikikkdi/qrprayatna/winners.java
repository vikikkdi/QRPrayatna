...
public class winners extends AppCompatActivity {
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new android.support.v7.app.AlertDialog.Builder(winners.this)
                .setMessage(message)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                for(int i=0;i<mobileArray.length;i++) {
                    Toast.makeText(winners.this, mobileArray[i], Toast.LENGTH_LONG).show();
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LayoutInflater layoutInflater = LayoutInflater.from(winners.this);
                View promptView = layoutInflater.inflate(R.layout.enterpass, null);
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(winners.this);
                ...
                alertDialogBuilder.setCancelable(false)
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                RequestQueue requestQueue1 = Volley.newRequestQueue(winners.this);
                                StringRequest stringRequest1 = new StringRequest(Request.Method.POST, "http://192.168.43.74:8081/check_pass.php",
                                        new Response.Listener<String>() {
                                            ...
                                            public void onResponse(String response) {
                                                if (response.equals("true")){
                                                    Toast.makeText(winners.this, "Login Successful", Toast.LENGTH_LONG).show();
                                                    Intent intent = new Intent(winners.this, MainActivity.class);
                                                    intent.putExtra("eventname", getIntent().getStringExtra("eventname"));
                                                    intent.putExtra("type","winners");
                                                    startActivity(intent);
                                                }else{
                                                    Intent intent=new Intent(winners.this, eventActivity.class);
                                                    intent.putExtra("eventname",getIntent().getStringExtra("eventname"));
                                    ...
                                    public void onErrorResponse(VolleyError volleyError) {
                                        Toast.makeText(winners.this, "Something went wrong", Toast.LENGTH_LONG).show();
        ...
        RequestQueue requestQueue1 = Volley.newRequestQueue(winners.this);
        StringRequest stringRequest1 = new StringRequest(Request.Method.POST, "http://192.168.43.74:8081/winners_check.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        if(response.equals("empty"))
                        {
                            Toast.makeText(winners.this, "No finalist added!!", Toast.LENGTH_LONG).show();
                        }
                        else{
                            mobileArray=response.split(":");
                            adapter = new ArrayAdapter<String>(winners.this,android.R.layout.simple_list_item_1, mobileArray);
    ...
    public void onBackPressed() {
        Intent inte = new Intent(winners.this, eventActivity.class);
